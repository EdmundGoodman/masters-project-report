...
def plot_performance():
    labels = ["Current\nxDSL", "Specialised\nxDSL", "MLIR"]
    perf_means = [924, 266, 11.7]
    perf_errors = [513, 34, 0.5]
    ...
    fig.tight_layout()
    # plt.show()
    save(fig, PARENT_DIRECTORY / "../specialising_optimising_xdsl_rewriting/trait_performance.pdf")


def plot_instructions():
    labels = ["Current\nxDSL", "Specialised\nxDSL", "MLIR"]
    perf_means = [89, 35, 708]
    ...
    fig.tight_layout()
    plt.show()
    save(fig, PARENT_DIRECTORY / "../specialising_optimising_xdsl_rewriting/trait_instructions.pdf")
