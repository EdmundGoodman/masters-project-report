...
% https://www.cst.cam.ac.uk/files/acs_project_marking.pdf
...
\newcommand{\wordcount}{14983}

\input{chapters/00_preamble}
\input{chapters/01_glossary}
...
%TC:ignore
% \pagenumbering{gobble} % https://www.cst.cam.ac.uk/local/phd/typography
\include{chapters/02_titlepage}
\include{chapters/03_coverpage}
\include{chapters/04_abstract}
\include{chapters/05_acknowledgements}
% \pagenumbering{roman}
\include{chapters/06_frontmatter}
...
\include{chapters/11_background}
\include{chapters/12_measuring_compiler_performance}
\include{chapters/13_profiling_python_bytecode}
\include{chapters/14_specialising_optimising_xdsl_rewriting}
\include{chapters/15_impact_cpython_optimisations}
\include{chapters/16_impact_dynamism}
\include{chapters/17_related_work}
\include{chapters/18_summary_conclusions}
\label{lastcontentpage} % end page count here
\zlabel{lastpdfcontentpage}

%TC:ignore
\include{chapters/20_bibliography}
