...
% This measurement relies on deep analysis of Python's internal evaluation machinery, which is not fully supported by existing tools. As such, we extend this existing body of work with a novel profiling tool, facilitating deep performance analysis of workloads which benefit from remaining in Python natively.
% Link
