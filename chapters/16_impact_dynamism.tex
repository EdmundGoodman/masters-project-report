...
We use the DynamoRIO \cite{brueningInfrastructureAdaptiveDynamic2003} tool to instrument these workloads, using the \texttt{countcalls} sample to count the number of direct and indirect calls.
% We can use this information to provide a lower bound for the cost of dynamic dispatch in the 
% Link
