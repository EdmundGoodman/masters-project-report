...
% Link
Whilst our constant folding pass is less complex than passes such as canonicalisation, it is still much more complex than any of the above micro-benchmarks. As such, there are many more opportunities for the specialisation of its implementation.
% Due to the length of the constant folding workload, there are many more opportunities for specialisation than in the above micro-benchmarks.
% Argument
Despite this, the overall approach is the same: removing unnecessary computation
% Link
...
% Hook
xDSL is a very large codebase, and as such is not tractable to fully optimise alone...
% Argument
