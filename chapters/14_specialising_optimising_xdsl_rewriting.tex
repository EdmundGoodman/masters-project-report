...
% Hook
Through this process of specialisation, we can improve the performance of this micro-benchmark by up to $26\times$ (\autoref{fig:ubenchmark-original-instantiation-performance}).
% Argument
% TODO: Discuss overhead in MLIR
% TODO: ...
% Link
...
\begin{figure}[H]
    ...
    % \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=0.5\textwidth]{images/specialising_optimising_xdsl_rewriting/instantiate_performance.pdf}
        \caption{.}
...
%% Re-introduce microbenchmark
% Hook
The second micro-benchmark discussed was checking traits on operations, and was measured to perform $\times$ worse in xDSL than \ac{mlir}.
% Argument
...
% Hook
Having specialised xDSL's implementation, we can draw direct comparison between it (Listing \ref{listing:ubenchmark-trait-checks-both-xdsl}) and MLIR's implementation (Listing \ref{listing:ubenchmark-trait-checks-both-mlir}), to better understand their relative performance characteristics.
% Argument
