...
% "This work demonstrates that the performance advantages traditionally attributed to static compilation are significantly diminished in the context of user-extensible compiler frameworks, where dynamic data structures and runtime heterogeneity are fundamental characteristics rather than implementation details."
% "Our findings reveal that modern interpreter optimizations have evolved to the point where they can effectively bridge the performance gap with static compilation for compiler framework workloads, while simultaneously providing superior development velocity and extensibility."
% "These results suggest that the compiler community should reconsider the automatic preference for static languages in framework design, as dynamic languages offer a more natural fit for the inherently runtime-dependent nature of modern heterogeneous compilation tasks while maintaining competitive performance."
